  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="relative">
        ...
        <div className="absolute left-0 top-0 w-20 h-full bg-gradient-to-r from-white dark:from-zinc-900 to-transparent pointer-events-none z-10" />
        <div className="absolute right-0 top-0 w-20 h-full bg-gradient-to-l from-white dark:from-zinc-900 to-transparent pointer-events-none z-10" />
      </div>
    </div>
  );
}
