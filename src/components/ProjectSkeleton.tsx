...
export const ProjectSkeleton = ({ className = "" }: ProjectSkeletonProps) => {
  return (
    <div className={`rounded-lg border border-neutral-300 dark:border-white/[0.08] bg-white dark:bg-white/[0.04] p-1 shadow-sm dark:shadow-none animate-pulse ${className}`}>
      <div className="flex flex-col gap-1">
        ...
        {/* Button Skeleton */}
        <div className="px-0">
          <div className="w-full rounded-lg bg-neutral-100 dark:bg-white/[0.04] border border-neutral-300 dark:border-white/[0.08] px-3 sm:px-4 py-2.5 sm:py-3">
...
export const MasonrySkeleton = ({ count = 3, className = "" }: MasonrySkeletonProps) => {
  return (
    <div className={`min-h-screen w-full bg-neutral-100 dark:bg-black p-2 sm:p-3.5 ${className}`}>
